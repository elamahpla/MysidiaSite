...
const Raiding = () => (
  <div className="RaidingContainer">
    <div className="RaidingText">
      <h1 style={{textAlign: 'center', textDecoration: 'underline'}}>The Village Idiots</h1>
        <p>The Village Idiots are a small group of FC members whose primary focus is clearing Savage content while trying to also have fun. While our primary focus is having fun, we also enjoy progressing on and killing bosses as they are available to us</p>
    </div>
